        ...
        <>
            <Combobox value={selected} onChange={onSelected} multiple>
                <div className="relative mt-1">
                    <div className="relative w-full cursor-default overflow-hidden rouded-lg
                     ...
                     sm:text-sm">
                        <Combobox.Input className="border-gray-300 dark:border-gray-700 dark:bg-gray-800
                    ...
                    >
                        <Combobox.Options
                            className="absolute max-h-60 mt-1 w-full overflow-auto
                             rounded-md bg-gray-900 py-1 text-base shadow-lg ring-1
                              ring-black/50 focus:outline-none sm:text-sm">
                                            ...
                                            {({selected, active}) => (
                                                <>
                                                    ...
                                                    { selected ? (
                                                        ...
                                                        left-0 flex items-center pl-3 text-white`}>
                                                            <CheckIcon
                                                                className="h-5 w-5"
                                                                aria-hidden="true"
                                                            />
